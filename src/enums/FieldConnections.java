...
public enum FieldConnections {
    ...
    CON_19(SAN_FRANCISCO,FIELD_6,TRAIN),
    ...
    CON_50(HEART_OF_AFRICA,FIELD_15,UNCHARTED),
    CON_51(HEART_OF_AFRICA,PYRAMIDS,UNCHARTED),
    CON_52(TUNGUSKA,FIELD_16,TRAIN),
    CON_53(TUNGUSKA,FIELD_19,TRAIN),
    CON_54(ANTARCTICA,FIELD_12,SHIP),
    CON_55(ANTARCTICA,SYDNEY,SHIP),
    CON_56(HIMALAYA,FIELD_17,UNCHARTED),
    CON_57(HIMALAYA,SHANGHAI,UNCHARTED),
    CON_58(FIELD_15,FIELD_11,SHIP),;
