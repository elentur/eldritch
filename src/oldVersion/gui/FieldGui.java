...
import static oldVersion.enums.Events.HEALTH;
import static oldVersion.enums.Events.SANITY;
import static oldVersion.enums.Events.recover;
import static oldVersion.gameBuild.Global.*;

import oldVersion.elements.Investigator;
import oldVersion.elements.Monster;
import oldVersion.enums.FieldTyps;
import oldVersion.enums.Phases;
...
public class FieldGui extends Group {
	...
	public FieldGui(Field field){
		...
		//oldVersion.investigators.setPadding(new Insets(20));
		...
		clueChanges();
		//////////////TEST///////////////
		//if(!field.getInvestigators().isEmpty())EventExecuter.runEvent(Global.game, field.getInvestigators().get(0),new Event(oldVersion.enums.Events.loose,1,oldVersion.enums.Events.SANITY,new Event(oldVersion.enums.Events.loose,1,oldVersion.enums.Events.HEALTH)));
