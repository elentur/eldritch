...
public class AmericaEncounter3 extends AmericaEncounter {

    public AmericaEncounter3( ) {
        super("ame_3");
        ...
        switch (getField().getFieldID()){
            case ARKHAM:
                Effect effect1 = new And(new Spend(SpendType.CLUE,1,getInvestigator()),
                        new GainSpell(Collections.singletonList(ItemType.INCANTATION),getInvestigator()));
            ...
            case BUENOS_AIRES:
                Effect effect2 = new And(new Spend(SpendType.CLUE,1,getInvestigator()),
                        new GainSpell(Collections.singletonList(ItemType.RITUAL),getInvestigator()));
