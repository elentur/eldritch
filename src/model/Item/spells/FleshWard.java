...
public class FleshWard extends Spell {
    ...
    public List<ItemBonus> createBonus() {
        ...
        bonus = new ItemBonus_PreventLossOfHealthOrSanity(2, SpendType.HEALTH, SituationType.ALL, RangeType.ALL, test, this);
    ...
    public List<SpellConsequence> getConsequence(Result result) {
        ...
        SpellConsequence con1 = new SpellConsequence(this.getNameId(), 1, new int[]{0, 1, 3}, Arrays.asList(
                new Or(new LooseOrGainHealthSanity(SpendType.HEALTH, -1, inv),
                        new GainCondition(ConditionType.INTERNAL_INJURY, inv)),
                new NullEffect(),
                customEffect
        ));
