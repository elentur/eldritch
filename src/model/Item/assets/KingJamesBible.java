...
public class KingJamesBible extends Asset {
    ...
    public List<ItemBonus> createBonus() {
        ...
        ItemBonus_Rest bonus1 = new ItemBonus_Rest(new LooseOrGainHealthSanity(SpendType.SANITY,1,LooseOrGainHealthSanity.ENCOUNTERING_INVESTIGATOR),RangeType.SELF,this);
        boni.add(bonus1);
